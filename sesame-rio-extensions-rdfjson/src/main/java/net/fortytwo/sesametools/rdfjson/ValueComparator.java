...
public class ValueComparator implements Comparator<Value>
{
    ...
    public int compare(final Value first, final Value second)
    {
        ...
        {
            final int cmp = first.stringValue().compareTo(second.stringValue());
            
            if(ValueComparator.EQUALS == cmp)
            {
                ...
                if(null == firstType)
                {
                    if(null == secondType)
                    {
                        ...
                        return null == firstLang ? (null == secondLang ? ValueComparator.EQUALS
                                : ValueComparator.BEFORE) : (null == secondLang ? ValueComparator.AFTER : firstLang
                                .compareTo(secondLang));
                    }
                    else
                    {
                        return ValueComparator.BEFORE;
